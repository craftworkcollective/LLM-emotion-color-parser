...
The Emotion name should be a real emotion, and only one word. The RGB values will be used to animate LEDs so there is no black or gray light. The RGB value should always be pink.
